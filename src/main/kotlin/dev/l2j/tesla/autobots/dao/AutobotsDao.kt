package dev.l2j.tesla.autobots.dao

import com.fasterxml.jackson.databind.DeserializationFeature
import com.fasterxml.jackson.module.kotlin.jacksonObjectMapper
import com.fasterxml.jackson.module.kotlin.readValue
import dev.l2j.tesla.autobots.Autobot
import dev.l2j.tesla.autobots.behaviors.preferences.ActivityPreferences
import dev.l2j.tesla.autobots.behaviors.preferences.DefaultCombatPreferences
            ...
            con.prepareStatement(LoadByName).use { ps ->
                ...
                ps.executeQuery().use { rs ->
                    ...
                    val socialPrefs = if(jsonSocialPrefs.isNullOrEmpty()) {
                        ...
                        AutobotsDao.mapper.readValue(jsonSocialPrefs, SocialPreferences::class.java)
                    }
