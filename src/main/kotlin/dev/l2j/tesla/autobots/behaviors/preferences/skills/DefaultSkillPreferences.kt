package dev.l2j.tesla.autobots.behaviors.preferences.skills
...
internal data class DreadnoughtSkillPreferences(
        override val skillUsageConditions: MutableList<SkillUsageCondition> = mutableListOf(
            SkillUsageCondition(
                braveheart,
                StatusCondition.Cp,
                ComparisonCondition.MoreOrEqualThan,
            ...
            SkillUsageCondition(
                revival,
                StatusCondition.Hp,
                ComparisonCondition.LessOrEqualThan,
...
internal data class PhoenixKnightSkillPreferences(
        override val skillUsageConditions: MutableList<SkillUsageCondition> = mutableListOf(
            SkillUsageCondition(
                shackle,
                StatusCondition.Distance,
                ComparisonCondition.MoreOrEqualThan,
                ConditionValueType.Amount,
                TargetCondition.PlayerTarget,
                300
            ),
            SkillUsageCondition(
                ultimateDefense,
