...
import dev.l2j.tesla.autobots.behaviors.preferences.skills.SagittariusSkillPreferences
...
internal class SagittariusBehavior(player: Player, combatPreferences: CombatPreferences) :
    CombatBehavior(player, combatPreferences), RequiresMiscItem, Kiter {

    override var skillPreferences: SkillPreferences =
        SagittariusSkillPreferences()
