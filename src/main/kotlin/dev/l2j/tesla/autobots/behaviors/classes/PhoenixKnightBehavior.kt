...
import dev.l2j.tesla.autobots.behaviors.preferences.skills.PhoenixKnightSkillPreferences
...
internal class PhoenixKnightBehavior(player: Player, combatPreferences: CombatPreferences) : CombatBehavior(player, combatPreferences),
    RequiresMiscItem {
