...
import dev.l2j.tesla.autobots.behaviors.preferences.skills.EvasTemplarSkillPreferences
...
internal class EvasTemplarBehavior(player: Player, combatPreferences: CombatPreferences) : CombatBehavior(player, combatPreferences),
    RequiresMiscItem {

    override var skillPreferences: SkillPreferences =
        EvasTemplarSkillPreferences()
